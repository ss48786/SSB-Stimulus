   ...
   class Homepage extends Component {
    ...
    renderItem = ({item}) => {
      ...
      return (
       ...
       <Button buttonName="Click on image" styleofppdtbutton={{width:150, marginLeft:10}} onButtonPress={()=>{this.Openmodal()}}/>
       </TouchableOpacity>
       <Modal
       transparent
       ...
       >
         <View style={{marginTop:380, marginLeft:10,marginRight:10,}}>
       <Image source = {imagePath.story1} style={{height:200,width:340}} />
       </View>
         </Modal>
      </View>
      );
    ...
    render() {
      const { imagearray,modalVisible } = this.state;
      const { navigation } = this.props;
  
      return (
        <SafeAreaView style={{ flex: 1, backgroundColor:colors.bgcolor }}>
        <View style={{flexDirection:'row', justifyContent:'center', backgroundColor:colors.bgcolor}}>
          <TouchableOpacity>
          <Text style={{color:colors.themeColor, fontWeight:'bold',fontSize:30
          }}>
        Picture Perception
          </Text>
          </TouchableOpacity>
        ...
        <View style={{marginTop:50,marginLeft:20}}>
          <Text style={{color:colors.themeColor, fontWeight:'bold',fontSize:20}}>Story Practicing</Text>
        </View>
        <FlatList
